    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataAccessLayer.GarageDataContext>
    {
        ...
        protected override void Seed(DataAccessLayer.GarageDataContext context)
        {
            ...
            context.ParkedVehicles.AddOrUpdate(
                p => p.RegNum,
                new ParkedVehicle { RegNum = "TYB735", Member = member1, VehicleType = vehicle1 },
                new ParkedVehicle { RegNum = "AAA001", Member = member2, VehicleType = vehicle2 },
                new ParkedVehicle { RegNum = "SLA071", Member = member3, VehicleType = vehicle3 },
                new ParkedVehicle { RegNum = "ANY719", Member = member4, VehicleType = vehicle4 }
                );
